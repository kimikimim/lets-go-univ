...
insert into universities (id, name_kr, region, type) values
  ('a0000000-0000-0000-0000-000000000001', '가톨릭대학교', '경기', '일반대'),
  ('a0000000-0000-0000-0000-000000000002', '고려대학교', '서울', '일반대'),
  ('a0000000-0000-0000-0000-000000000003', '광주과학기술원(GIST)', '광주', '과학기술원'),
  ('a0000000-0000-0000-0000-000000000004', '대구경북과학기술원(DGIST)', '대구', '과학기술원'),
  ('a0000000-0000-0000-0000-000000000005', '서울대학교', '서울', '일반대'),
  ('a0000000-0000-0000-0000-000000000006', '연세대학교', '서울', '일반대'),
  ('a0000000-0000-0000-0000-000000000007', '울산과학기술원(UNIST)', '울산', '과학기술원'),
  ('a0000000-0000-0000-0000-000000000008', '한국과학기술원(KAIST)', '대전', '과학기술원')
