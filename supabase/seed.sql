...
insert into universities (id, name_kr, region, type, address) values
  ('a0000000-0000-0000-0000-000000000001', '가톨릭대학교', '경기', '일반대', '경기도 부천시 원미구 지봉로 43'),
  ('a0000000-0000-0000-0000-000000000002', '고려대학교', '서울', '일반대', '서울특별시 성북구 안암로 145'),
  ('a0000000-0000-0000-0000-000000000003', '광주과학기술원(GIST)', '광주', '과학기술원', '광주광역시 북구 첨단과기로 123'),
  ('a0000000-0000-0000-0000-000000000004', '대구경북과학기술원(DGIST)', '대구', '과학기술원', '대구광역시 달성군 현풍읍 테크노중앙대로 333'),
  ('a0000000-0000-0000-0000-000000000005', '서울대학교', '서울', '일반대', '서울특별시 관악구 관악로 1'),
  ('a0000000-0000-0000-0000-000000000006', '연세대학교', '서울', '일반대', '서울특별시 서대문구 연세로 50'),
  ('a0000000-0000-0000-0000-000000000007', '울산과학기술원(UNIST)', '울산', '과학기술원', '울산광역시 울주군 언양읍 유니스트길 50'),
  ('a0000000-0000-0000-0000-000000000008', '한국과학기술원(KAIST)', '대전', '과학기술원', '대전광역시 유성구 대학로 291')
